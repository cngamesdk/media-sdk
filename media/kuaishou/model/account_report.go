...
func (receiver *AccountReportReq) Format() {
	receiver.accessTokenReq.Format()
}

func (receiver *AccountReportReq) Validate() (err error) {
...
// AccountReportResp 广告主数据响应数据（仅data部分）
type AccountReportResp struct {
	TotalCount int64                 `json:"total_count"` // 数据的总行数
	Details    []AccountReportDetail `json:"details"`     // 数据明细信息
}
